...
import type { VPConfig } from './velocityPaintEngine';

interface R3VelocityPaintRefractProps {
  config?: Partial<VPConfig>;
}

export default function R3VelocityPaintRefract({ config }: R3VelocityPaintRefractProps) {
  ...
  useEffect(() => {
    ...
    const engine = new VelocityPaintEngine(glCtx, config);
