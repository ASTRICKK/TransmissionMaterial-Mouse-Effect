...
export default function MouseFluid() {
  ...
  const controls = useControls({
    ...
    transmissionMaterial2: folder({
      ...
      ior2: { value: 2.5, min: 1.0, max: 2.5, step: 0.01, label: 'IOR' },
      ...
      caIntensity2: { value: 2.00, min: 0.0, max: 2.0, step: 0.01, label: 'CA Intensity' },
      caEdgeWidth2: { value: 0.20, min: 0.001, max: 0.2, step: 0.001, label: 'CA Edge Width' },
      gradAmp2: { value: 3.0, min: 1.0, max: 20.0, step: 0.1, label: 'Gradient Amplify' },
      roughness2: { value: 0.00, min: 0.0, max: 1.0, step: 0.01, label: 'Roughness' },
      causticInt2: { value: 0.50, min: 0.0, max: 2.0, step: 0.01, label: 'Caustic Intensity' },
      specPower2: { value: 64, min: 1.0, max: 1024.0, step: 1.0, label: 'Specular Power' },
      specIntensity2: { value: 0.40, min: 0.0, max: 1.0, step: 0.01, label: 'Specular Intensity' },
      fresnelPower2: { value: 10.0, min: 0.5, max: 10.0, step: 0.1, label: 'Fresnel Power' },
      fresnelIntensity2: { value: 0.50, min: 0.0, max: 1.0, step: 0.01, label: 'Fresnel Intensity' },
